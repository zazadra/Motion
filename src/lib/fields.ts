...
export const DEFAULT_FIELDS: SessionField[] = [
  ...
  { id:'leader_email',      label:'Team Leader Email',                                     type:'email',    required:true,  enabled:true,  placeholder:'email@example.com', attachedCheckbox: { id:'newsletter', label:'I would be open to receiving your newsletter' } },
